    ...
    <section class="ui-section-hero">
      <div class="ui-layout-container">
        <div class="ui-section-hero__layout ui-layout-grid ui-layout-grid-2">
          ...
          <!-- IMAGE -->
          <img src="./assets/neymar1.jpg" loading="lazy" alt="#" class="ui-image-half-right">
        </div>
      </div>
    </section>
      ...
      <div class="ui-layout-container">
        <div class="ui-section-feature__layout ui-layout-grid ui-layout-grid-3">
          <div class="ui-component-card ui-component-card--feature">
            <img src="./assets/coach_bipin.jpg" alt="#" loading="lazy">
          ...
          <div class="ui-component-card ui-component-card--feature">
            <img src="./assets/coach_kiran.jpg" alt="#" loading="lazy">
            <div class="ui-component-card--feature-content">
          ...
          <div class="ui-component-card ui-component-card--feature">
            <img src="./assets/coach_anupam.jpg">
            <div class="ui-component-card--feature-content">
    ...
    <section class="ui-section-testimonial">
      <div class="ui-layout-container">
        <div class="ui-layout-column-4 ui-layout-column-center">
          <img src="./assets/owner.jpg" alt="#" class="ui-section-testimonial--avatar">
        ...
        <div class="ui-section-pricing__layout ui-layout-grid ui-layout-grid-3">
          <div class="ui-component-card ui-component-card--pricing">
            ...
            <div class="ui-component-card--pricing-price">
              <span class="ui-component-card--pricing-amount ui-component-card--pricing-amount-1" id="price"></span>
              <span>/</span>
              <span>month</span>
            </div>
          ...
          <div class="ui-component-card ui-component-card--pricing">
            ...
            <!-- AMOUNT -->
            <div class="ui-component-card--pricing-price">
              <span class="ui-component-card--pricing-amount ui-component-card--pricing-amount-2" id="price"></span>
              <span>/</span>
              <span>month</span>
            </div>
          ...
          <div class="ui-component-card ui-component-card--pricing">
            ...
            <!-- AMOUNT -->
            <div class="ui-component-card--pricing-price">
              <span class="ui-component-card--pricing-amount ui-component-card--pricing-amount-3" id="price"></span>
              <span>/</span>
              <span>month</span>
            </div>
